...
public class JavaSocketServer {
    /*
    This class is designed to emulate the socket server that would normally be running on the roboRIO 
    It is used for offline developement on tegra vision code and can be run from terminal or a java IDE
